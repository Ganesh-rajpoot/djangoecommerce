...
from .models import Cart,Customer,Product,OrderPlace
...
def laptop(request,data=None):
    ...
    elif data == 'acer' or data == 'dell' or data == 'macbook':
        laptops = Product.objects.filter(category='L').filter(brand = data)
    elif data == 'below':
        laptops = Product.objects.filter(category='L').filter(discounted_price__lt = 20000)
    elif data == 'above':
